...
def process_pdf_and_search(protein_preference, calorie_preference, ingredient_preference):
    ...
    query = f"Give me a meal and recipe with about {protein_preference} grams of protein and about {calorie_preference} calories using {ingredient_preference} and any other ingredients from Pooja's recipes. If you don't know, suggest the closest recipe with the calorie, protein, and ingredients."
